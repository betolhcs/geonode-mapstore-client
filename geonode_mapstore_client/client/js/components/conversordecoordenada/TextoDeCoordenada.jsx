    ...
    return (<>
        <tr>
            ...
            <div style={{marginBottom: "7px"}}>
                <button style={{'float': "left", marginRight: "3px", marginBottom: "3px"}} type="button" disabled={botaoDesabilitado} className="botoes-do-plugin" onClick={handleCopiar}>Copiar coordenadas</button>
